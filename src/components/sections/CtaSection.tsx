  ...
  return (
    <section id="cta-final" className="py-16 md:py-24 bg-gradient-to-br from-primary via-red-700 to-background text-primary-foreground">
      <div className="container mx-auto px-4 md:px-8 text-center">
        ...
        <p className="font-body text-lg md:text-xl max-w-xl mx-auto mb-10 animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-200">
          Aventureiro do paladar, aceite o convite! Experimente nosso molho artesanal 100% natural Mango Magma e transforme suas refeições em uma aventura picante, tropical e inesquecível.
        </p>
        <Button 
          size="lg" 
          variant="secondary"
        ...
        <p className="font-body text-sm mt-8 animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-600">
          Entrega em todo o Brasil. Molho artesanal Mango Magma 150ml, feito com ingredientes puros, direto da raiz para sua mesa.
        </p>
      </div>
    </section>
  );
